      ...
      <main>
        ...
        <section class="product-list">
          <div class="product-list">
            <div class="product" data-price="10" onclick="window.location.href='pags/producto.php'">
            ...
            <div class="product" data-price="15" onclick="window.location.href='pags/producto.php'">
              <div class="product-img">
            ...
            <div class="product" data-price="20" onclick="window.location.href='pags/producto.php'">
              <div class="product-img">
