  ...
  <div class="container">
    <header>
      ...
      <section class="terms-section">
        ...
        <p>Bienvenido a Flash Market. Al acceder o utilizar nuestro sitio web, aceptas cumplir con los siguientes términos y condiciones:</p>

        <h2>1. Uso del Sitio</h2>
        <p>Los usuarios se comprometen a utilizar el sitio únicamente para fines lícitos y conforme a la legislación vigente.</p>

        <h2>2. Propiedad Intelectual</h2>
        <p>Todo el contenido, incluyendo logos, textos, imágenes y código, son propiedad de Flash Market y no pueden ser reproducidos sin autorización.</p>

        <h2>3. Compras y Pagos</h2>
        <p>Los precios están sujetos a cambios sin previo aviso. Flash Market se reserva el derecho de rechazar cualquier pedido.</p>
        ...
        <p>Si tienes preguntas, contáctanos a <a href="mailto:soporte@flashmarket.com">soporte@flashmarket.com</a>.</p>
      </section>
    </main>
        <footer class="footer">
